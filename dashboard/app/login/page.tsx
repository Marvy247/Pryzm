      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[45%] flex-col justify-between p-12 relative">
        ...
        >
          <Link href="/" className="flex items-center gap-2 group w-fit">
            ...
            <span className="font-bold text-2xl tracking-tight text-white">PRYZM</span>
          </Link>
        </motion.div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <p className="text-xl text-slate-400 leading-relaxed max-w-lg">
              Autonomous agents scan Somnia DreamDEX markets, calculate probability edges, and execute trades automatically.
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: Zap, label: "7-Agent Swarm", desc: "Parallel market analysis" },
              { icon: Shield, label: "Risk-Managed", desc: "Kelly criterion sizing" },
              { icon: TrendingUp, label: "Auto-Execute", desc: "IOC order placement" },
            ].map((item, i) => (
              <motion.div
                key={item.label}
      ...
      <div className="flex-1 flex flex-col lg:w-1/2 xl:w-[55%]">
        ...
        >
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight text-white">PRYZM</span>
          </Link>
